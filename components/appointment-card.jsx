...
export function AppointmentCard({
  ...
  return (
    <>
      <Card className="border-sky-200 hover:border-sky-300 transition-all">
              ...
              <Badge
                ...
                className={
                  appointment.status === "COMPLETED"
                    ...
                    ? "bg-red-50 border-red-900/30 text-red-400"
                    : "bg-amber-50 border-amber-900/30 text-amber-400"
                }
              >
                {appointment.status}
              </Badge>
              ...
              {appointment.status === "SCHEDULED" && (
                <div>
                  {appointment.reminderSent ? (
                    ...
                    <span className="inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-0.5 rounded-full bg-slate-50 border border-slate-200 text-slate-500">
              ...
              <div className="flex gap-2 mt-2 flex-wrap">
                {canMarkCompleted() && (
                  <Button
                    ...
                    className="bg-gradient-to-r from-sky-500 to-cyan-500 hover:from-sky-600 hover:to-cyan-600 border-0"
                  >
                    {completeLoading ? (
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <div className="h-5 w-5 text-sky-600 mr-2">
                  {otherPartyIcon}
                </div>
                <div>
            ...
            {appointment.patientDescription && (
              <div className="space-y-2">
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-sky-200">
                ...
                {userRole === "DOCTOR" &&
                  ...
                  appointment.status !== "CANCELLED" && (
                    <Button
                      ...
                      className="h-7 text-sky-600 hover:text-sky-600 hover:bg-sky-50"
                    >
              ...
              {userRole === "DOCTOR" && action === "notes" ? (
                <div className="space-y-3">
                  <Textarea
                    ...
                    className="bg-background border-sky-200 min-h-[100px]"
                  />
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-sky-200 min-h-[80px]">
                  {appointment.notes ? (
                    <p className="text-gray-900 whitespace-pre-line">
                      {appointment.notes}
                    </p>
            ...
            <div className="flex gap-2">
              ...
              {appointment.status === "SCHEDULED" && (
                <Button
                  ...
                  className="border-red-900/30 text-red-400 hover:bg-red-50 mt-3 sm:mt-0"
                >
                  {cancelLoading ? (
                    <>
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
