...
import { Calendar, Clock, DollarSign, ClipboardList } from "lucide-react";
...
import PatientProgress from "./_components/patient-progress";
...
export default async function DoctorDashboardPage() {
  ...
  return (
    ...
    >
      <TabsList className="md:col-span-1 bg-muted/30 border h-14 md:h-52 flex sm:flex-row md:flex-col w-full p-2 md:p-1 rounded-md md:space-y-2 sm:space-x-2 md:space-x-0">
        <TabsTrigger
          value="earnings"
