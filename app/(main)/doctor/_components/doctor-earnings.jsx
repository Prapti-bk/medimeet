    ...
    <div className="space-y-6">
      ...
      <Card className="border-sky-200">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-muted/20 p-4 rounded-lg border border-sky-200">
            <div className="flex items-center justify-between mb-3">
              ...
              {pendingPayout ? (
                <Badge
                  variant="outline"
                  className="bg-amber-50 border-amber-900/30 text-amber-600"
                >
                  PROCESSING
                </Badge>
              ) : (
            ...
            {!pendingPayout && availableCredits > 0 && (
              <Button
                ...
                className="w-full mt-4 bg-gradient-to-r from-sky-500 to-cyan-500 hover:from-sky-600 hover:to-cyan-600 border-0"
              >
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                {payouts.slice(0, 5).map((payout) => (
                  <div
                    key={payout.id}
                    className="flex items-center justify-between p-3 rounded-md bg-muted/10 border border-sky-100"
                  >
                    <div>
                      <p className="text-gray-900 font-medium">
                    ...
                    <Badge
                      ...
                      className={
                        payout.status === "PROCESSED"
                          ...
                          : "bg-amber-50 border-amber-900/30 text-amber-600"
                      }
                    >
                      {payout.status}
                    </Badge>
        ...
        <DialogContent>
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            <div className="bg-muted/20 p-4 rounded-lg space-y-2">
              ...
              <div className="border-t border-sky-200 pt-2 flex justify-between font-medium">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-background border-sky-200"
                required
              />
              <p className="text-sm text-muted-foreground">
